...
def main():
    ...
    start_date = "1987-09-03 01:00:00"
    end_date  =  "1987-10-01 00:00:00"
    file_rechunked = "/glade/derecho/scratch/ishitas/CONUS/chrtout/chrtout.zarr"
    os.remove('/glade/derecho/scratch/ishitas/CONUS/chrtout/chrtout_write_in_progress.lock') 
    file_chunk_fix = file_rechunked.replace(".zarr", "_fix.zarr")
    script_path = '/glade/work/ishitas/CONUS_Retro_Run/rechunk_retro_nwm_v21/chrtout/chrtout_to_zarr_fix.py' 
    ...
    ds_B.drop(['crs','elevation', 'feature_id', 'gage_id', 'latitude', 'longitude', 'order']).to_zarr(file_rechunked, region={"time": region_update})
