...
# User config
output_path = pathlib.Path("/glade/derecho/scratch/ishitas/Alaska/forcing")
...
coord_file = '/glade/p/cisl/nwc/nwm_forcings/Alaska/AORC/regridded/1981010100.LDASIN_DOMAIN1'

# input_dir = "/glade/campaign/ral/hap/zhangyx/AORC.Forcing"
input_dir = '/glade/p/cisl/nwc/nwm_forcings/Alaska/AORC/regridded'
start_date = "2019-11-14 00:00"
freq = "1h"
