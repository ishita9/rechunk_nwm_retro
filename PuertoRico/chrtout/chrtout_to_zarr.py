...
# User config
output_path = pathlib.Path("/glade/scratch/arezoo/PR/chrtout")

# Chunk config
time_chunk_size = 672
feature_chunk_size = 14017
...
end_date = '2023-06-30 23:00'  # full time
#end_date = '2008-02-01 23:00'
...
input_dir = "/glade/p/cisl/nwc/nwmv30_finals/PuertoRico/retro_final/OUTPUT_RTOUT_COMPRESSED/"
start_date = "2008-01-01 01:00"
freq = "1h"
...
def get_gage_id():
    chrtout_file = pathlib.Path(
        '/glade/p/cisl/nwc/nwmv30_finals/PuertoRico/retro_final/OUTPUT_CHRTOUT_COMPRESSED/'
        '200801010100.CHRTOUT_DOMAIN1')
    rl_file = pathlib.Path(
        '/glade/p/cisl/nwc/nwmv30_finals/PuertoRico/DOMAIN_WCOSS_Names/'
        'RouteLink_PRVI.nc')
