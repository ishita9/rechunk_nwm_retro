...
def main():
    ...
    start_date = "2014-02-13 03:00:00"
    end_date  =  "2014-03-13 00:00:00"
    file_rechunked = "/glade/p/datashare/ishitas/rtout/rtout.zarr"
    os.remove('/glade/p/datashare/ishitas/rtout/rtout_write_in_progress.lock') 
    file_chunk_fix = file_rechunked.replace(".zarr", "_fix.zarr")
    script_path = '/glade/work/ishitas/CONUS_Retro_Run/rechunk_retro_nwm_v21/rtout/rtout_to_zarr_fix.py' 
    ...
    ds_B.drop('x').drop('y').drop('crs').to_zarr(file_rechunked, region={"time": region_update})
