...
def main():
    ...
    start_date = "1983-10-06 01:00:00"
    end_date  =  "1983-11-03 00:00:00"
    file_rechunked = "/glade/derecho/scratch/ishitas/CONUS/gwout/gwout.zarr"
    os.remove('/glade/derecho/scratch/ishitas/CONUS/gwout/gwout_write_in_progress.lock') 
    file_chunk_fix = file_rechunked.replace(".zarr", "_fix.zarr")
    script_path = '/glade/work/ishitas/CONUS_Retro_Run/rechunk_retro_nwm_v21/gwout/gwout_to_zarr_fix.py' 
    ...
    ds_B.drop(['feature_id']).to_zarr(file_rechunked, region={"time": region_update})
