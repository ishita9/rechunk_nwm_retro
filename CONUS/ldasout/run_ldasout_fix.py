...
def main():
    ...
    start_date = "2001-03-29 03:00:00"
    end_date  =  "2001-04-26 00:00:00"
    file_rechunked = "/glade/derecho/scratch/ishitas/CONUS/ldasout/ldasout.zarr"
    os.remove('/glade/derecho/scratch/ishitas/CONUS/ldasout/ldasout_write_in_progress.lock') 
    file_chunk_fix = file_rechunked.replace(".zarr", "_fix.zarr")
    script_path = '/glade/work/ishitas/CONUS_Retro_Run/rechunk_retro_nwm_v21/ldasout/ldasout_to_zarr_fix.py' 
