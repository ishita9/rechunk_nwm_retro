...
# User config
output_path = pathlib.Path("/glade/derecho/scratch/ishitas/CONUS/chrtout")
...
end_date = '2023-02-01 00:00'  # full time
...
def get_gage_id():
    chrtout_file = pathlib.Path(
        '/glade/campaign/ral/hap/mazrooei/NWMV30/retro.v3.0_FullPhysics/'
        '1979/197902020000.CHRTOUT_DOMAIN1')
    rl_file = pathlib.Path(
        '/glade/p/cisl/nwc/nwmv30_finals/CONUS/DOMAIN_WCOSS_Names/'
        'RouteLink_CONUS.nc')
