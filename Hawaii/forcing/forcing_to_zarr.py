...
output_path = pathlib.Path(
    "/glade/scratch/arezoo/HI/forcing")
...
end_date = '2013-12-31 23:00' # full time
...
coord_file = '/glade/p/cisl/nwc/nwmv30_finals/Hawaii/DOMAIN_WCOSS_Names/GEOGRID_LDASOUT_Spatial_Metadata_HI.nc'

# input_dir = "/glade/campaign/ral/hap/zhangyx/AORC.Forcing"
input_dir = '/glade/scratch/arezoo/hawaii_forcing/output'
