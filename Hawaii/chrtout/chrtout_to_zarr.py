...
# User config
output_path = pathlib.Path("/glade/scratch/arezoo/HI/chrtout")

# Chunk config
time_chunk_size = 672
feature_chunk_size = 13637
...
end_date = '2014-01-01 13:30'  # full time
...
input_dir = "/glade/p/cisl/nwc/nwmv30_finals/Hawaii/retro_final/OUTPUT_CHRTOUT_COMPRESSED/"
start_date = "1994-01-01 00:15"
freq = "15T"
...
def get_gage_id():
    chrtout_file = pathlib.Path(
        '/glade/p/cisl/nwc/nwmv30_finals/Hawaii/retro_final/OUTPUT_CHRTOUT_COMPRESSED/'
        '199401010015.CHRTOUT_DOMAIN1')
    rl_file = pathlib.Path(
        '/glade/p/cisl/nwc/nwmv30_finals/Hawaii/DOMAIN_WCOSS_Names/'
        'RouteLink_HI.nc')
